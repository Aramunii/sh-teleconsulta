...
const app = express();
const options = {
    key: fs.readFileSync('/etc/letsencrypt/live/node-sign.supporthealth.com.br/fullchain.pem'),
    cert: fs.readFileSync('/etc/letsencrypt/live/node-sign.supporthealth.com.br/privkey.pem')
}
